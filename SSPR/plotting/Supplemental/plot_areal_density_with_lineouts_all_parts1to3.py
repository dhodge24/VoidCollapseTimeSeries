# Use if the 3 plots will be separate and have their own captions
...
# LINE STYLES / COLORS
# ----------------
# Same styling as your corrected version
profile_styles = {
    "GT": {
        "color": "black",
        "linestyle": "-",
...
def plot_chunk(start_idx, end_idx, part_num):
    ...
    # If only one row ever gets used, keep axs 2D
    if n_chunk == 1:
    ...
    # SAVE / SHOW
    # ----------------
    save_path = f"/Users/danielhodge/Desktop/arealDensitiesAll_part{part_num}.pdf"
    plt.savefig(
        save_path,
        dpi=300,
        bbox_inches="tight",
