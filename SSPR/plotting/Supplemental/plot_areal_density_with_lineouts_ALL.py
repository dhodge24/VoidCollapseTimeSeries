...
# PROFILE LOCATIONS
# ----------------
# Reordered to match the swapped run order:
# original rows 5 and 6:
# run 580: center - 100, center + 450
# run 582: center - 50,  center + 300
#
# new rows 5 and 6:
# run 582 first, then run 580
profile_positions = [
...
# LINE STYLES / COLORS
# ----------------
# Same styling as the correct 4-row version:
# GT: solid black, thicker
# Simulation: solid magenta, thinner
# Experiment: solid dark orange, thinner
profile_styles = {
    "GT": {
        "color": "black",
        "linestyle": "-",
...
for r in range(n_runs):
    ...
    for c in range(3):
        ...
        # Vertical and horizontal profile-location lines match
    ...
    # Legend on every vertical profile
    ...
    # Legend on every horizontal profile
...
# ----------------
plt.savefig(
    "/Users/danielhodge/Desktop/arealDensitiesAll.pdf",
    dpi=300,
    bbox_inches="tight",
    pad_inches=0.03
)
