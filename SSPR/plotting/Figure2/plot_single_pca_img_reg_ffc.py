...
# PATH
# ----------------
img_path = f"/Users/danielhodge/Desktop/all_runs/run{run}_sim/run{run}_sim_holos_with_speckle_FFC_extended_decon.tiff"
...
# ----------------
# TITLE (multi-line for readability)
# ----------------
ax.set_title(
    "PCA + Registration\n+ Deconvolution",
    fontsize=22,
...
save_path = f"/Users/danielhodge/Desktop/single_pca_registration_run{run}.pdf"
