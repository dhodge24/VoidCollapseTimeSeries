...
# PATH
# ----------------
img_path = f"/Users/danielhodge/Desktop/GT_adjusted_maps/run{run}_GT_maps/phi_adjusted.tiff"
...
# DISPLAY RANGE
# ----------------
clim_img = (-55, -15)   # use low, high order
...
# TITLE
# ----------------
ax.set_title("xRAGE Phase", fontsize=22, fontweight="bold")
...
save_path = f"/Users/danielhodge/Desktop/single_GT_phase_run{run}.pdf"
