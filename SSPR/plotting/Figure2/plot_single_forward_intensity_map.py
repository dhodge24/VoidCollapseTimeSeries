...
# PATH
# ----------------
img_path = f"/Users/danielhodge/Desktop/all_runs/run{run}_sim/run{run}_sim_holos_with_speckle_orig.tiff"
...
# TITLE
# ----------------
ax.set_title("Simulated\nIntensity Map", fontsize=22, fontweight="bold")
...
save_path = f"/Users/danielhodge/Desktop/single_forward_model_intensity_run{run}.pdf"
