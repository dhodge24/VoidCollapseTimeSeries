...
# PATHS
# ----------------
# simulated areal density
sim_path = f"/Users/danielhodge/Desktop/time_series_recon_cropped_areal_dens/run{run}_sim/areal_density_run{run}sim.tiff"

# experimental areal density reconstruction
exp_path = f"/Users/danielhodge/Desktop/time_series_recon_cropped_areal_dens/run{run}_exp/areal_density_run{run}exp.tiff"
...
# ----------------
# Match the alignment treatment you used for the phase example.
# Adjust or comment out if not needed.
...
save_path = f"/Users/danielhodge/Desktop/single_areal_density_sim_exp_composite_run{run}.pdf"
