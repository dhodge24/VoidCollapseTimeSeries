...
# PATH
# ----------------
img_path = f"/Users/danielhodge/Desktop/Inverse_Abel/run{run}_sim/run_{run}_sim_inverse_Abel_data_regularized_Gaussian_blurred8_mass_density.tiff"
...
# DISPLAY RANGE
# ----------------
clim_img = (0.0, 5.5)   # adjust as needed for reconstructed mass density
...
save_path = f"/Users/danielhodge/Desktop/single_reconstructed_mass_density_run{run}.pdf"
