...
# PATHS
# ----------------
# simulated PCA + registration + deconvolution
sim_path = f"/Users/danielhodge/Desktop/all_runs/run{run}_sim/run{run}_sim_holos_with_speckle_FFC_extended_decon.tiff"

# experimental PCA + registration + deconvolution
exp_path = f"/Users/danielhodge/Desktop/all_runs/run{run}_exp_preprocessed/run{run}_exp_holos_with_speckle_FFC_extended_decon.tiff"
...
# ----------------
# Keep this if you want the same alignment treatment.
# If this processed image is already aligned the way you want,
...
save_path = f"/Users/danielhodge/Desktop/single_pca_registration_sim_exp_composite_run{run}.pdf"
