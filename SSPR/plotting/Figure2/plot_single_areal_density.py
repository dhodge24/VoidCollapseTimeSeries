...
# PATH
# ----------------
img_path = f"/Users/danielhodge/Desktop/GT_adjusted_maps/run{run}_GT_maps/areal_density_total_adjusted.tiff"
...
# TITLE
# ----------------
ax.set_title(f"xRAGE Areal Density", fontsize=22, fontweight="bold")
...
save_path = f"/Users/danielhodge/Desktop/single_GT_areal_density_run{run}.pdf"
