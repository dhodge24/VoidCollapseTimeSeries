...
img = np.array(imread("/Users/danielhodge/Desktop/obj_ramp_removed.tiff"), dtype=np.float32)
Ny, Nx = img.shape
dx_eff = 30e-9
dy_eff = 30e-9
...
noise_threshold_freq = 6  # Threshold frequency in um^-1. This is manually chosen based off the power spectrum plot.
